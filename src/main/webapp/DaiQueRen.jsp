...
<script>
    function que(id){
        ...
        location.href="${app}/WeiRuZhu.jsp";
    }
    $(function () {
        var id = ${sessionScope.admin.id};
        $.ajax({
            "url":"${app}/admin_orderController/selectByStateNext",
            "type":"get",
            "data":{"admin_id":id},
            "dataType":"json",
            "success":function (data){
                $(data).each(function () {
                    $("#ty").append("<tr><td>"+this.user_name+"</td>"+
                        ...
                        "<td>"+this.count+"</td>"+
                        "<td>"+this.day+"</td>"+
                        "<td><input type='button' value='确认' onclick='que("+this.id+")' class='btn btn-info'></td>"+
                        "<td><input type='button' value='拒接' onclick='ju("+this.id+")' class='btn btn-info'></td></tr>"
                    );
        ...
        function ju(id) {
            $.ajax({
                "url":"${app}/admin_orderController/NoOrder",
                "type":"get",
                "data":{"id":id},
                "dataType":"json",
                "error":function () {
