...
<script>
    $(function () {
        var id=${sessionScope.Specialty.id}
            $("#table").empty();
        $.ajax({
            url:"${app}/SpecialtyMapper/selectAllSpecialty",
            data:{"admin_id":id},
            dataType:"json",
            type:"post",
    ...
    function del (id) {
        /*$.ajax({
            url:'${app}/specialtyController/deleteSpecialty',
            type:'post',
            data:{'id':id},
            datatype:'json',
        })
        alert("删除成功！")
        location.href="${app}/goods.jsp";*/
    }
</script>
...
<!-- 模态框 -->
<form action="${app}/SpecialtyMapper/insertSpecialty" method="post" enctype="multipart/form-data">
