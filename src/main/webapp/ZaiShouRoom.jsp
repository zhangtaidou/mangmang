...
<body>
<div class="add_blank" type="" >您有新的订单,请注意查看</div>
...
<script>
                ...
                $(data).each(function () {
                    if(data != null){
                        ...
                        $("#TB").append("<tr><td>" + this.name + "</td>" +
                            ...
                            "<td><input type='button' value='下架'  onclick='Xj(" + this.id + ")' class='btn btn-info'></td>"
                        )
                    }else{
                        var tr= $("<tr>")
                        $("#TB").append(tr)
    ...
    function ins(){
        ...
        alert(name)
        $.ajax({
            "url":"${app}/roomController/addRoom",
            "type":"post",
            "data":{"name":name,"price":price,"img":img,"introduce":introduce,"count":count,"state":state},
            "dataType":"json",
            "error":function () {
                alert("数据库异常请联系管理员");
            }
