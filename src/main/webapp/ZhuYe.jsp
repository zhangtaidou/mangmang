                    ...
                    <div class="row row-sm text-center">
                        ...
                        <div class="col-xs-6">
                            <div class="panel padder-v item bg-info">
                                ...
                                <span class="text-muted text-xs">酒店访问量</span>
                                <div class="top text-right w-full">
                                    <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6">
                            <div class="panel padder-v item bg-primary">
                                <div class="h1 text-fff font-thin h1">521</div>
                                <span class="text-muted text-xs">入驻数量</span>
                                <div class="top text-right w-full">
                                    <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                </div>
                            </div>
                ...
                <div class="col-sm-3" style="padding-left:0;">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content" style="border-top:none;background-color:#e4eaec;">
                            ...
                            <h5>流失店家</h5>
                            <div class="progress progress-striped active">
                                <div style="width: 5%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" role="progressbar" class="progress-bar progress-bar-warning">
                                    <span class="sr-only"></span>
                                </div>
                            </div>
                            <h5>新增店家</h5>
                            <div class="progress progress-striped active">
                                <div style="width: 35%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" role="progressbar" class="progress-bar .progress-bar-danger">
                                    <span class="sr-only"></span>
                                </div>
                            </div>
                            <h5>新增店家</h5>
...
<!-- Flot -->
<script src="${app}/js/plugins/flot/jquery.flot.js"></script>
<script src="${app}/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="${app}/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="${app}/js/plugins/flot/jquery.flot.pie.js"></script>
<!-- 自定义js -->
